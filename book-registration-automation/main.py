...
class Window(Frame):
    ...
    def ekle(self):
        ...
        self.BasimYil = Spinbox(self.F_ekle, from_=0, to = 2025, width=5)
...
root = Tk()
app = Window(root)
root.wm_title("Kitap Kayıt Sistemi |03.12.2025")
...
me = Label(root, text="Developer: @behramaras", fg="#6E7371",cursor="hand2",font="Verdana 7 bold")
me.pack(side=BOTTOM)
me.bind("<Button-1>", lambda e: callback(webbrowser.open_new("https://github.com/behramaras")))
